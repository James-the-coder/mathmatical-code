...
buttonMult = Button(frame, text='*', height=4, width=9, font=35, command= lambda: button_press('*'))
buttonMult.grid(row=2,column=3)

buttonDiv = Button(frame, text='/', height=4, width=9, font=35, command= lambda: button_press('/'))
